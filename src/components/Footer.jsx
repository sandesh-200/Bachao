  ...
  return (
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12 grid md:grid-cols-4 gap-8">
        ...
        <div>
          <div className="flex items-center mb-4">
            ...
            <h3 className="text-2xl font-bold">Bachaoo</h3>
          </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li className="flex items-center">
              ...
              <span className="text-gray-400">ERC</span>
            </li>
            <li className="flex items-center">
              <Phone className="mr-2 w-4 h-4 text-blue-300" />
              <span className="text-gray-400">+977 (555) 123-4567</span>
            </li>
            <li className="flex items-center">
              <Mail className="mr-2 w-4 h-4 text-blue-300" />
              <span className="text-gray-400">support@bachaoo.org</span>
            </li>
          </ul>
        </div>
      ...
      <div className="bg-gray-800 py-4 text-center text-sm text-gray-400">
        © {new Date().getFullYear()} Bachaoo. All Rights Reserved.
      </div>
    </footer>
  )
}
